 ...
 * Properties
 */
export interface S3BucketPublicReadProhibitedProps extends config.RuleProps {
  /**
 ...
 */
export class S3BucketPublicReadProhibited extends config.ManagedRule {
   ...
   * @param props
   */
  constructor(scope: cdk.Construct, id: string, props: S3BucketPublicReadProhibitedProps = {}) {
    super(scope, id, {
      ...props,
    ...
    this.ssmRole = new iam.Role(this, 'SSMRole', {
      roleName: 'S3OperationsAutomationsExecutionRole-Read',
